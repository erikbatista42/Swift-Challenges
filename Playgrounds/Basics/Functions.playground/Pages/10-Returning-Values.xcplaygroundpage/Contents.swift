...
let halfPi = degreesToRadians(degrees: halfPiRadiansInDegrees) // Roughly 1.57
print(halfPi)
//let pi = degreesToRadians(degrees: piRadiansInDegrees) // Roughly 3.14
//let twoPi = degreesToRadians(degrees: twoPiRadiansInDegrees) //  6.28
...
calculateRotationForPolygon(sides: 4)
